...
class Route
{
    ...
    /**
     * Get Proper Route  
     * return the controller and function in route
     * @return array
     */
    ...
    /**
     * Determine if the given pattern matches the current url
     *
    ...
    /**
     *  Generate a regex pattren for the given url
     * 
     * @param string $url
     * @return string
     */
